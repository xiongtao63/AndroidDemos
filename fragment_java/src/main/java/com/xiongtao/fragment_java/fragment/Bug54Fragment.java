...
public class Bug54Fragment extends BaseFragment {
    ...
    public static Fragment newIntance(final String name) {
        Bug54Fragment fragment = new Bug54Fragment();
    ...
    public void onAttach(Activity activity) {
        ...
        Log.i("Zero","onAttach Bug54Fragment");
    ...
    public void onDetach() {
        super.onDetach();
        Log.i("Zero","onDetach Bug54Fragment");
    }
